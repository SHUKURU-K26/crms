...
<head>
    ...
    <title>GuestPro CMS| Expenses</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div style="display: flex;justify-content:space-between;">
                        <h1 class="h3 mb-6" style="color: dodgerblue;font-weight:bold;font-family:Cambria;">Expenses Status</h1>
                ...
                <div class="card shadow mb-4" >
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Expense Dynamic Data View</h6>
                    </div>
                    <div class="card-body" >                                            
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                                    <thead>
                                        <tr>                                            
                                            ...
                                            <th>Recent Transaction Method</th>
                                            <th>Balance</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <?php
                                        include "../../web_db/connection.php";
                                        $sql="SELECT ec.car_name AS car_name,
                                            ec.plate_number AS plate,
                                            ec.provider AS provider,
                                            ec.days_in_service AS days_in_rent,
                                            ec.total_spending AS total_spending,              
                                            ec.payment_method AS payment_method,
                                        ...
                                        $result=$conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                ...
                                                <tr>                                            
                                                    ...
                                                    <td><?php echo $row["days_in_rent"]?></td>
                                                    <td id="total_spending"><?php echo $row["total_spending"]- $row["balance"] ?></td>
