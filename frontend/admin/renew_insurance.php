...
<head>
    ...
    <title>GuestPro CMS| Renew Car</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Renew Insuarance</h1>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title"><i class="fas fa-exclamation-triangle" style="color: red;"></i>
                                                    Renew Insurance of <?php echo $row["car_name"]?>
                                                </h4>
                                ...
                                <?php
                                 if (isset($_POST['Save'])) {   
                                    $car_name = $_POST['car_name'];                                                                       
                                     ...
                                     $updateSql = "UPDATE cars SET insurance_issued_date = ?, insurance_expiry_date = ? WHERE  plate_number = ?";
                                     $updateStmt = $conn->prepare($updateSql);
                                     $updateStmt->bind_param("sss", $renew_date, $expiry_date, $plate_number);

                                     if ($updateStmt->execute()) {
                                         include "../../system_messages/insuranceRenewMessage.php";
                                     } else {
                                         echo "<script>alert('Error renewing insurance. Please try again.');</script>";
                                     }
                                     $updateStmt->close();
                                    # code...
                                 }
