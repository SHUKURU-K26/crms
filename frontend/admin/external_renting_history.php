...
<head>
    ...
    <title>GuestPro CMS| External Renting History</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div style="display: flex;justify-content:space-between;">
                        <h1 class="h3 mb-6" style="color: dodgerblue;font-weight:bold;font-family:Cambria;">External Renting History</h1>
                        ...
                        <div class="table-responsive" >
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                                    ...
                                    <tbody>
                                        <?php
                                        include "../../web_db/connection.php";
                                        $sql="SELECT * FROM renting_history WHERE history_type='external' ORDER BY rent_date ASC";
