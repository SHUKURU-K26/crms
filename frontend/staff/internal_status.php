...
<head>
    ...
    <title>GuestPro CMS| System Overview</title>
...
<body id="page-top">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>                                            
                                            ...
                                            <th>Type</th>
                                            <th>Fuel</th>
                                            <th style="width: 90px;">IID</th>
                                            <th style="width: 90px;">IED</th>
                                            <th style="width: 90px;">CID</th>
                                            <th style="width: 90px;">CED</th>
                                            <th>Status</th>                                            
                                        </tr>
                                    ...
                                    <tbody>
                                     ...
                                     $result=$conn->query($sql);
                                        ...
                                        <tr>                                            
                                            ...
                                            <td style="font-size: 14px;"><?php echo $row["plate_number"]?></td>
                                            <td><?php echo $row["type"]?></td>
                                            <td><?php echo $row["fuel_type"]?></td>
                                            <td><?php echo $row["insurance_issued_date"]?></td>
                                            <td><?php echo $row["insurance_expiry_date"]?></td>
                                            <td><?php echo $row["control_issued_date"]?></td>
                                            <td><?php echo $row["control_expiry_date"]?></td>
    ...
    document.querySelectorAll("#dataTable tbody tr td:nth-child(11)").forEach(td => {
