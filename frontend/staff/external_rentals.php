...
<head>
    ...
    <title>GuestPro CMS| External Rented Cars</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div style="display: flex;justify-content:space-between;">
                        <h1 class="h6 mb-2"><strong style="color: dodgerblue;">All External Rentals Provided By:</strong>
                        ...
                        <div class="table-responsive">                          
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                     <?php
                                     include "../../web_db/connection.php";                              
                                     $sql = "SELECT r.renter_full_name, r.id_number, r.telephone, r.negotiated_price, r.rent_date, r.return_date, r.days_in_rent, r.total_fee,
                                    c.car_id, c.car_name, c.plate_number, c.type,u.user_id, u.full_name AS provider_name FROM external_rentals r
                                    INNER JOIN external_cars c ON r.car_id = c.car_id
