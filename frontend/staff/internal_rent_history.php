            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div style="display: flex;justify-content:space-between;">
                        <h1 class="h4 mb-6" style="color: dodgerblue;font-weight:bold;font-family:Cambria;">Your Internal Renting History</h1>
                        ...
                        <div class="table-responsive" >
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
                                    ...
                                    <tbody>
                                        <?php
                                        include "../../web_db/connection.php";
                                        $sql="SELECT * FROM rental_history WHERE provider_names='$user_full_names' ORDER BY date_rented_on DESC";
